export const test3 = [
    ...
    {
      "Question": "Choose the word that is opposite, or almost opposite to theword: CHILDISH",
    ...
    {
      "Question": "Fill in the missing words:The office space was used as economically as possible. All ofthe tables were ______ up against one another, so all theemployees were having to sit next to each other closely. Eachdesk was given two monitors to work with and each had theirown metal cabinet to put their ______ items into for safekeeping.",
    ...
    {
      "Question": "Everyone was already ____, so the company decided on hiringa new employee to help with the workload.",
    ...
    {
      "Question": "A recipe for making 100g of dark chocolate requires 70% cocoamass. In order to make 400g of dark chocolate, how manygrams of cocoa mass would be required?",
    ...
    {
      "Question": "Fill in the missing words:There can be a lot of rain in the months of Winter. The highstreet was not built to adequately deal with this ______ ofrainwater. The drains were unable to cope, and the roads andpaths became flooded. Many shops had to close down frombeing _____ by the overflowing water.",
    ...
    {
      "Question": "Fills in the missing words:The professor did his best to make sure he was deliberately______ as he gave his lecture. This way, his students could notunderstand him, and he was able to continue pretending that heknew what he was talking about. In fact, he didn�t know his______ very well, as he was a poor professor.",
    ...
    {
      "Question": "Choose the word that is opposite, or almost opposite to theword: AGILE",
    ...
    {
      "Question": "The apprentice boulderer _____ ever higher up the cliff face,using all the rock-climbing techniques she could to get to thetop.",
    ...
    {
      "Question": "Hardback books sell for $20 and Paperback books sell for $10.How many more Paperback books can you buy than Hardbackbooks with $180?",
      "Options": ['5', '6', '8', '9', '10'],
      "Images": [],
    ...
    {
      "Question": "Which year saw the greatest drop of energy consumption ofprimary fuel from the previous year?",
    ...
    {
      "Question": "In 2013, how many more million tonnes of Fresh fish were therethan Frozen fish?",
    ...
    },
    {
      ...
      "Solution": "Step 1:  Each box must contain at least 2 objects. The mask and flag are in the  right box. Therefore, the right box is covered.    Step 2:  The paintbrush and buckle are in the box next to the one with the  mask, the right box. Therefore, the centre-right box is covered.    Step 3:  The jigsaw is on the left, along with the ocarina. Therefore, the left is  covered. The keychain is next to the buckle, thus the centre-left but it only has one  object. So, the eight object the whisk will be placed in this box to satisfy the two  object a box rule. Therefore, the correct answer is centre-left.",
      "Answer": 2,
      "type":3,
    },
    {
    ...
    {
      "Question": "Yoko runs around a track at a constant speed of 200m every 1minute. The track is 1000m in length a lap. How many laps willshe be able to run around the track in 40 minutes?",
    ...
    {
      "Question": "In 2015, how many more million tonnes of Cured fish werethere than Tinned fish?",
    ...
    {
      "Question": "Choose the word that is opposite, or almost opposite to theword: ENJOY",
    ...
    {
      "Question": "There are four numbers: 23, 28, 16, and 17. A fifth numbercreates a group average of 20. What is this fifth number?",
    ...
    {
      "Question": "Handwash sells for $1.75 per carton, and Shower gel sells for$2.50 per carton. How many more cartons of Handwash canyou buy than Shower gel with $35.00?",
      "Options": ['3', '4', '5', '6', '8'],
      "Images": [],
    ...
    {
      "Question": "It takes Roshni 40 minutes to jog from home to the park at anaverage pace of 6mph. Her gym is another 20 minutes jog fromthe park. How far away is the gym from her home?",
    ...
    {
      "Question": "In 2021, how much cyber-attacks were Malicious Insiders in theUK?",
      "Options": ['1.2', '(B)', '(C)', '(D)', '(E)'],
    ...
    {
      "Question": "There are three numbers: 111, 265, and 409. A fourth numbercreates a group average of 250. What is this fourth number?",
